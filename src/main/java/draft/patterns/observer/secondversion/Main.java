package draft.patterns.observer.secondversion;
...
public class Main {
    public static void main(String[] args) {
        ...
        IObservador mayor =new ObservadorMayor(n);
        n.Attach(new DecoradorRegistro(mayor));
        IObservador menor = new ObservadorMenor(n);
        n.Attach(new DecoradorRegistro(menor));
        IObservador impares = new ObservadorImpares(n);
        n.Attach(new DecoradorRegistro(impares));
        IObservador pares = new ObservadoresPares(n);
        n.Attach(new DecoradorRegistro(pares));
...
class DecoradorRegistro  implements IObservador {
    ...
    public void Actualizar() {
        System.out.print(observadorDecorado.getClass().getSimpleName() + ": ");
